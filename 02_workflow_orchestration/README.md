...
A couple of minutes after executing the _`docker compose up`_ command, the webserver should be running. Navitgate to http://localhost:8080/home in your browser. You should be greeted by a sign in form like so:
